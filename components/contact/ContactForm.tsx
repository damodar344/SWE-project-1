              ...
              <div>
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    className={`flex-1 ${formData.preferredContact === "Email" ? "bg-yellow-400 text-gray-800" : "bg-yellow-400/80 text-gray-800"}`}
                  >
                    Email
                  </Button>
                  <Button
                    ...
                    className={`flex-1 ${formData.preferredContact === "Phone No." ? "bg-yellow-400 text-gray-800" : "bg-yellow-400/80 text-gray-800"}`}
                  >
                    Phone No.
                  </Button>
                </div>
