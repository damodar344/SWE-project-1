...
import { User, Listing, Profile, Preferences, ContactInfo } from "./models";
  ...
  try {
    ...
    try {
      ...
      await transporter.sendMail({
        from: '"ShareIT" <noreply@shareit.com>',
        to: userData.email,
...
<body>
  <div class="container">
    <div class="header">
      <h1>ShareIT - Student Housing Platform</h1>
    </div>
    <div class="content">
      <h2>Welcome to ShareIT!</h2>
      <p>Thank you for joining our community. We're excited to have you on board!</p>
      <p>To complete your registration and access all features of ShareIT, please verify your email address by clicking the button below:</p>
      <div style="text-align: center;">
        <a href="${
          process.env.NEXT_PUBLIC_APP_URL
        }/api/verify?token=${verificationToken}" class="button">Verify Email Address</a>
      </div>
      <p>If the button above doesn't work, you can also copy and paste the following link into your browser:</p>
      <p style="word-break: break-all; font-size: 12px; color: #666666;">
        ${process.env.NEXT_PUBLIC_APP_URL}/api/verify?token=${verificationToken}
      </p>
      <p>This verification link will expire in 24 hours for security reasons.</p>
      <p>If you didn't create an account with ShareIT, you can safely ignore this email.</p>
    </div>
    <div class="footer">
...
`,
      ...
      // Don't throw here, we still want to return success since the account was created
    }
